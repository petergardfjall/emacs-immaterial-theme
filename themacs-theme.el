...
(let ((class '((class color) (min-colors 89)))
      (fg1      (themacs-color "foreground-1"))
      (fg2      (themacs-color "foreground-2"))
      (fg3      (themacs-color "foreground-3"))
      (bg1      (themacs-color "background-1"))
      (bg2      (themacs-color "background-2"))
      (bg3      (themacs-color "background-3"))
